...
```sh
# 安装 WebView2 运行时
wget https://go.microsoft.com/fwlink/p/?LinkId=2124703 -O MicrosoftEdgeWebView2RuntimeInstaller.exe
wine MicrosoftEdgeWebView2RuntimeInstaller.exe
