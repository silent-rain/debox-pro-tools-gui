export const ROUTES = {
  ...
  PERSONAL_CENTER_IMPORT_ACCOUNT_FORM: '/personal-center/import-account/form',
  ...
  PERSONAL_CENTER_HELP: '/personal-center/help',
  PERSONAL_CENTER_ABOUT: '/personal-center/about',
};
