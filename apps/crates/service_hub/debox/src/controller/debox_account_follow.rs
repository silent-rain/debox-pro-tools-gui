...
impl DeboxAccountFollowController {
    ...
    pub async fn list(
        ...
        let (results, total) = debox_account_follow_service.list(&ctx, req).await?;
    ...
    pub async fn info(
        ...
        let debox_account_follow_service: DeboxAccountFollowService = provider.provide();
        let result = debox_account_follow_service.info(&ctx, req).await?;
    ...
    pub async fn create(
        ...
        let debox_account_follow_service: DeboxAccountFollowService = provider.provide();
        let _result = debox_account_follow_service.create(&ctx, req).await?;
    ...
    pub async fn update(
        ...
        let debox_account_follow_service: DeboxAccountFollowService = provider.provide();
        let _result = debox_account_follow_service.update(&ctx, req).await?;
    ...
    pub async fn delete(
        ...
        let debox_account_follow_service: DeboxAccountFollowService = provider.provide();
        let _result = debox_account_follow_service.delete(&ctx, req).await?;
...
impl DeboxAccountFollowController {
    ...
    pub async fn sync_follows(
        ctx: Context,
        Extension(provider): Extension<AInjectProvider>,
        Json(req): Json<SyncDeboxAccountFollowsReq>,
    ) -> Responder<SyncDeboxAccountFollowsResp> {
        let debox_account_follow_service: DeboxAccountFollowService = provider.provide();
